            ...
            <div class="card mt-3">
                <div class="card-body text-center">
                    ...
                    <div class="card-text">
                        ...
                        <div class="mt-0">
                            <a href="<?php echo e(route('login')); ?>" class="card-text">ログインはこちら</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/auth/register.blade.php ENDPATH**/ ?>