<div class="card mt-3">
    ...
    <div class="card-body pt-0 pb-2 pl-3">
        <div class="card-text">
            <article-like :initial-is-liked-by='<?php echo json_encode($article->isLikedBy(Auth::user()), 15, 512) ?>' :initial-count-likes='<?php echo json_encode($article->count_likes, 15, 512) ?>' :authorized='<?php echo json_encode(Auth::check(), 15, 512) ?>' endpoint="<?php echo e(route('articles.like', ['article' => $article])); ?>">
            </article-like>
        </div>
    </div>
...
<?php /**PATH /var/www/html/resources/views/articles/card.blade.php ENDPATH**/ ?>