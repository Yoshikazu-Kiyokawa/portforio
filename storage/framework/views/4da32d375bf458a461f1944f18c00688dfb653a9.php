<div class="card mt-3">
  <div class="card-body">
    ...
    <h2 class="h5 card-title m-0">
      <a href="<?php echo e(route('users.show', ['name' => $person->name])); ?>" class="text-dark"><?php echo e($person->name); ?></a>
    </h2>
  </div>
</div><?php /**PATH /var/www/html/resources/views/users/person.blade.php ENDPATH**/ ?>